...
const sidebarData2: string[] = ["Goal", 
  "Edukasi Keuangan"
];
  ...
  return (
    <>
      ...
      <aside
        ...
        aria-label="Sidebar"
      >
        <div class="h-full px-3 py-4 overflow-y-auto bg-[#FFB22C] rounded-r-3xl rounded-br-3xl flex flex-col justify-between">
          <section>
            <button class="hover:bg-gray-700 hover:text-white rounded-lg w-full p-2 flex items-center justify-start gap-x-4">
