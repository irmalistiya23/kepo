      ...
      <div className="dashboard-row row-top">
        <div className="card">
          <div className="card-content">
            <div className="card-text">
              ...
              <button className="read-more" onClick={navigateToEducation}>
                Mulai
              </button>
            </div>
            <img
              className="card-image"
              src="/img/dashboard/edu-icon.png"
              alt="Edukasi"
            />
          </div>
        </div>
        ...
        <div className="card">
          <div className="card-content">
            ...
            <img
              className="card-image"
              src="/img/dashboard/savings-icon.png"
              alt="Tabungan"
            />
          </div>
        </div>
      ...
      <div className="dashboard-row row-bottom">
          ...
          {recentActivities.length === 0 ? (
            ...
            <ul className="activity-list">
              {recentActivities.map((activity, index) => (
                <li
                  key={index}
                  className={activity.type === "income" ? "income" : "expense"}
                >
                  <div className="activity-header">
                    <span className="category">{activity.category}</span>
                    <span className="amount">
                      {activity.type === "income" ? "+" : "-"}Rp.
        ...
        <div className="card">
          ...
          <select
            value={filterType}
            onChange={(e) =>
              setFilterType(e.target.value as "year" | "month" | "week")
            }
          ...
          />
          <button className="read-more" onClick={navigateToAnalysis}>
            Lihat Detail
          </button>
        </div>
      </div>
